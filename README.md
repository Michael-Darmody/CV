...
| [Rhythm is a Maker](https://github.com/Michael-Darmody/rhythm-is-a-maker) | As a group named 'The Spice Boys' and combining our common interests of code and music, We created a high quality music maker web application. This required great teamwork and great analyses of how to use tools and technologies we'd never used before, combined with all the skills we'd previously acquired, all in the short time frame of 2 weeks. | 2 weeks |HTML/CSS, Express.js, Tone.js | Karma, Cypress, Travis CI |
